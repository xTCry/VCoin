...
function getCurCompletions() {
	let temp = _stateCmd == StateCmd.NONE? "coins, stop, run, buy, tran, price, color, hideupd, autoBuy, autoBuyItem, smartBuy, tspam, beep, debug, datecolorbg, token, to, info, gid":
